...
export class PropertyPanelDesign extends LitElement {
  ...
  render() {
    ...
    const layoutOptions = [
      { value: 'text-below', label: this.t('variant.layout.textBelow') },
      { value: 'text-right', label: this.t('variant.layout.textRight') }
    ];

    return html`
      <div class="section-content">
        <ui-select 
          label="${this.t('variant.layout')}" 
