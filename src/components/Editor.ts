    ...
    return html`
      ...
      <div class="workspace">
        <editor-left-sidebar
          ...
          .variantsLabel="${this.t('sidebar.variants')}"
          .randomLabel="${this.t('variant.random')}"
          .t="${this.t}"
        ...
        <editor-preview
          ...
          .playLabel="${this.t('preview.alert')}"
          .sendTestLabel="${this.t('preview.sendTest')}"
          .optionsLabel="${this.t('preview.options')}"
          .widthLabel="${this.t('preview.width')}"
          .heightLabel="${this.t('preview.height')}"
          .selectLabel="${this.t('preview.select')}"
